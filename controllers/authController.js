...
const createSendToken = (user, statusCode, res, req, status = "success") => {
...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  createSendToken(newUser, 201, res, req, "not verified");
});
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  if (!user.emailVerified) {
    ...
    return createSendToken(user, 200, res, req, "not verified");
  }
